...
def shell(data):  # Сортировка Шелла (SHELL) - модификация сортировки вставками (InsertSort)
        inc = len(data) // 2
        while inc:
...
table = prettytable.PrettyTable(["Размер списка", "Время сортировки Шелла", "Время быстрой сортировки"])
x = []
y1 = []
y2 = []
